...
const useBuilderStore = create(immer((set, get) => ({
  ...
  addItem: (type) =>
      set((state) => {
        ...
        switch (type) {
          case 'Header':
            newItem.properties.text = 'Header Module'; // <-- 'Header Module'로 통일
            break;
          case 'Footer':
            newItem.properties.text = 'Footer Module'; // <-- 'Footer Module'로 통일
            break;
          case 'Button':
            newItem.properties.text = 'Button Module'; // <-- 'Button Module'로 통일
